...
export declare const getPathToAnchorByBlockchainId: (token: Token, anchorToken: Token) => any;
export declare const findPath: (pathObject: ConversionPathsTokens, blockchainType: BlockchainType) => Promise<any[]>;
